        ...
        [
            {
                ...
                "sales_signals_json": {
                    "top_performing_arguments": [
                        "table généreuse pour repas d'été sans vocabulaire promotionnel agressif",
                        "matière naturelle et ligne architecturale perçues comme premium",
                        "dimensions visibles tôt dans la fiche pour rassurer sur l'usage terrasse",
                        "finitions sobres mieux converties quand elles sont reliées à une scène de vie extérieure",
                    ],
                    "conversion_notes": [
                        "valoriser la matière et la stabilité sans promettre de résistance permanente",
                        "placer largeur, profondeur, hauteur et capacité dans les specs visibles",
                        "préférer un bénéfice d'usage concret à un superlatif",
                    ],
                ...
                "feedback_signals_json": {
                    "perceived_strengths": [
                        ...
                        "présence premium sans surcharge visuelle",
                    ],
                    "customer_questions": [
                        "entretien en extérieur",
                        "nombre de couverts",
                        "dimensions réelles sur terrasse",
                        "ce qui est réellement certifié ou non",
                    ],
                    "copy_risks": [
                        "ne pas transformer FSC Mix Credit en 100 % FSC",
                        "ne pas promettre zéro entretien",
                        "ne pas étendre une preuve matière aux composants exclus",
                    ],
                },
                "generated_at": _NOW,
                "is_active": True,
