...
class TechnicalDossierIngestionWorkflow:
    ...
    async def _run_ingestion(
        ...
        # # Flow complet réactivé après validation du custom extractor.
        # # Cette suite était temporairement coupée pendant les tests classifier/extractor.
        # workflow.logger.info(
        #     "Technical dossier | persistance candidats démarrée | "
        #     f"ingestion_run_id={prepared.ingestion_run_id} "
        #     f"candidate_count={len(extraction.candidates)}"
        ...
        # TEMPORAIRE - reprise du flow complet après validation du custom extractor.
        # workflow.logger.info(
        #     "Technical dossier | persistance candidats démarrée | "
        #     f"ingestion_run_id={prepared.ingestion_run_id} "
        #     f"candidate_count={len(extraction.candidates)}"
