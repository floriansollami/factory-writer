...
description: Master workflow orchestration architecture with Temporal, covering fundamental design decisions, resilience patterns, and best practices. Use this skill when making design decisions about workflow structures.
---
